...
const val BA_ACTIVITIES_DETECTED = "$PACKAGE_NAME.BA_ACTIVITIES_DETECTED"
const val IE_DETECTED_ACTIVITIES = "$PACKAGE_NAME.IE_DETECTED_ACTIVITIES"
...
private fun buildNoti(context: Context, channelId: String, title: String, content: String, intent: PendingIntent): Notification {
    ...
    return NotificationCompat.Builder(context, channelId)
        .setSmallIcon(R.drawable.padc_logo)
